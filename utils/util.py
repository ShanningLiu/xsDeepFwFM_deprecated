...
def get_model(cuda, feature_sizes, pars, dynamic_quantization=False, static_quantization=False, quantization_aware=False, field_size=39, deep_nodes=100):
    return DeepFMs.DeepFMs(field_size=field_size, feature_sizes=feature_sizes,
                           ...
                           h_depth=pars.h_depth, deep_nodes=deep_nodes, num_deeps=pars.num_deeps,
