...
"""
source: https://github.com/mightydeveloper/Deep-Compression-PyTorch/blob/master/net/quantization.py
"""
...
def apply_weight_sharing(model, bits=5):
    ...
    for name, module in model.named_children():
        # perform weight sharing only in fc layers
        if 'emb' in name or 'drop' in name:
            continue
