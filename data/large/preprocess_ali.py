...
def generate_feature_map_and_train_csv(inputs, file_feature_map):
    feature_map = []
    ...
    for i in range(17, len(list(inputs.columns))):
...
feature_map = generate_feature_map_and_train_csv(train, 'ali_feature_map')
#
